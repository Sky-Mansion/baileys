...
> credit : https://github.com/itsliaaa/baileys <br>
...
# GitHub
"dependencies": {
   "baileys": "github:Sky-Mansion/baileys"
}
```
...
```bash
# GitHub
npm i github:Sky-Mansion/baileys
```
...
```javascript
// --- ESM
import { makeWASocket } from '@Sky-Mansion/baileys'

// --- CJS (tested and working on Node.js 24 ✅)
const { makeWASocket } = require('@Sky-Mansion/baileys')
```
...
```javascript
import { makeWASocket, delay, DisconnectReason, useMultiFileAuthState } from '@Sky-Mansion/baileys'
...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from '@Sky-Mansion/baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
sock.sendMessage(jid, {
   ...
   publisher: '🌟 Lia Wynn',
   description: '@Sky-Mansion/baileys'
}, {
   quoted: message
})
```
...
sock.sendMessage(jid, {
   ...
   couponCode: '@Sky-Mansion/baileys', // --- Optional
   nativeFlow: [{
      text: '👋🏻 Greeting',
      id: '#Greeting'
   }, {
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      couponCode: '@Sky-Mansion/baileys',
      nativeFlow: [{
         text: '🌐 Source',
         url: 'https://www.npmjs.com/package/baileys'
      }]
...
```javascript
// --- Create a new one
sock.newsletterCreate('@Sky-Mansion/baileys')
...
// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 @Sky-Mansion/baileys')
...
sock.groupCreate('@Sky-Mansion/baileys', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 @Sky-Mansion/baileys')
