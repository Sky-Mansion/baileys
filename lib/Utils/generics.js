...
export const generateMessageIDV2 = (userId) => {
   ...
   const baseId = 'BP11' + hex.substring(0, 18);
   const pos = 4 + (hash[0] & 15);
   return baseId.slice(0, pos) + 'BPRO1100' + baseId.slice(pos);
};
// generate a random ID to attach to a message
export const generateMessageID = () => 'BP11' + randomBytes(18).toString('hex').toUpperCase();
...
export const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/Sky-Mansion/baileys/main/lib/Defaults/index.js';
    try {
