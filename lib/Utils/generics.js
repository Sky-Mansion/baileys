...
// helper used for producing prettier, hyphen-delimited ids
const beautify = (id) => {
...
export const generateMessageIDV2 = (userId) => {
   ...
   const baseId = 'BP1100' + hex.substring(0, 18);
   const pos = 4 + (hash[0] & 15);
   const rawId = baseId.slice(0, pos) + 'BP1100' + baseId.slice(pos);
   return beautify(rawId);
};
// generate a random ID to attach to a message
export const generateMessageID = () => beautify('BP1100' + randomBytes(18).toString('hex').toUpperCase());
