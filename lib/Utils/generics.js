...
export const generateMessageIDV2 = (userId) => {
   ...
   const baseId = 'පකයා' + hex.substring(0, 18);
   const pos = 4 + (hash[0] & 15);
   const rawId = baseId.slice(0, pos) + 'ILSYM2' + baseId.slice(pos);
   return beautify(rawId);
};
// generate a random ID to attach to a message
export const generateMessageID = () => beautify('පකයා' + randomBytes(18).toString('hex').toUpperCase());
